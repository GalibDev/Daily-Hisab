...
export function AiFloatingHelper() {
  ...
  if (!open) return <button type="button" onClick={() => setOpen(true)} aria-label="Open AI Helper" className="fixed bottom-[calc(6.8rem+env(safe-area-inset-bottom))] right-4 z-[60] rounded-[20px] bg-white p-1.5 shadow-[0_14px_36px_rgba(17,41,143,0.28)] ring-1 ring-[#dbe4ff] lg:bottom-6"><AiLogo /></button>;

  return (
    <section role="dialog" aria-label="Floating AI Helper" className="fixed bottom-[calc(6.8rem+env(safe-area-inset-bottom))] right-3 z-[60] flex h-[430px] w-[calc(100vw-1.5rem)] max-w-[360px] flex-col overflow-hidden rounded-[22px] border border-[#dbe4ff] bg-white shadow-[0_24px_64px_rgba(13,35,100,0.28)] lg:bottom-6 lg:right-6">
